...
$generated_i18n_strings = array(
	...
	// Reference: src/vue/pages/sitemaps/views/pro/VideoSitemap.vue:427
	...
	// Reference: src/vue/pages/sitemaps/views/pro/VideoSitemap.vue:443
	...
	// Reference: src/vue/pages/search-appearance/views/pro/ImageSeo.vue:87
	__( 'Title Attribute Format', 'aioseo-pro' ),

	// Reference: src/vue/pages/search-appearance/views/pro/ImageSeo.vue:88
	__( 'Strip Punctuation for Title Attributes', 'aioseo-pro' ),

	// Reference: src/vue/pages/search-appearance/views/pro/ImageSeo.vue:89
	__( 'Click on the tags below to insert variables into your title attribute.', 'aioseo-pro' ),

	// Reference: src/vue/pages/search-appearance/views/pro/ImageSeo.vue:90
	__( 'Alt Tag Attribute Format', 'aioseo-pro' ),

	// Reference: src/vue/pages/search-appearance/views/pro/ImageSeo.vue:91
	__( 'Click on the tags below to insert variables into your alt tag attribute.', 'aioseo-pro' ),

	// Reference: src/vue/pages/search-appearance/views/pro/ImageSeo.vue:92
	...
	// Reference: src/vue/pages/redirects/views/pro/RedirectsActivate.vue:77
	...
	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/partialsProduct/GenericProduct.vue:148
	...
	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/partialsProduct/GenericProduct.vue:152
	__( 'Price', 'aioseo-pro' ),

	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/partialsProduct/GenericProduct.vue:151
	...
	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/Recipe.vue:274
	...
	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/Recipe.vue:278
	__( 'Rating', 'aioseo-pro' ),

	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/Recipe.vue:279
	__( 'Average Rating', 'aioseo-pro' ),

	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/Recipe.vue:280
	__( 'Amount of ratings', 'aioseo-pro' ),

	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/partialsProduct/WooCommerceProduct.vue:66
	__( 'Brand', 'aioseo-pro' ),

	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/partialsProduct/GenericProduct.vue:153
	__( 'Price Valid Until', 'aioseo-pro' ),

	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/partialsProduct/GenericProduct.vue:154
	__( 'The date until this pricing lasts (optional).', 'aioseo-pro' ),

	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/partialsProduct/GenericProduct.vue:155
	__( 'Availability', 'aioseo-pro' ),

	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/partialsProduct/WooCommerceProduct.vue:67
	__( 'Identifier Type', 'aioseo-pro' ),

	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/partialsProduct/WooCommerceProduct.vue:68
	__( 'The unique global product identifier (optional).', 'aioseo-pro' ),

	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/partialsProduct/WooCommerceProduct.vue:69
	__( 'Identifier', 'aioseo-pro' ),

	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/partialsProduct/GenericProduct.vue:159
	__( 'Reviews', 'aioseo-pro' ),

	// Reference: src/vue/pages/post-settings/views/pro/partialsSchema/partialsProduct/WooCommerceProduct.vue:71
	...
	// Reference: src/vue/components/pro/local-business/BusinessContact.vue:42
	__( 'Email Address', 'aioseo-pro' ),

	// Reference: src/vue/components/pro/local-business/BusinessContact.vue:43
	__( 'Phone Number', 'aioseo-pro' ),

	// Reference: src/vue/components/pro/local-business/BusinessContact.vue:44
	...
	// Reference: src/vue/pages/settings/views/WebmasterTools.vue:617
	/* Translators: 1 - A link to our documentation, 2 - HTML line break tag. */
	...
	// Reference: src/vue/pages/settings/views/WebmasterTools.vue:645
	/* Translators: 1 - A link to our documentation, 2 - HTML line break tag. */
