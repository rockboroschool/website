            ...
            if ( version_compare( $wp_version, '5.4.2' , '>=' ) ) {
                wp_localize_script(
                  ...
                  array(
                    ...
                    'defaultString'    => __( 'Default', 'customizr' ),
                    'defaultAriaLabel' => __( 'Select default color', 'customizr' ),
                    'pick'             => __( 'Select Color', 'customizr' ),
                    'defaultLabel'     => __( 'Color value', 'customizr' )
                  )
                );
            }
